...
import { Collumn } from 'primereact/column';
    ...
    render(){
        return (
           ...
           <Container>
                ...
                >   
                    <Collumn field="docPubTopic" header="หัวข้อ" />
                    <Collumn field="docPubDate" header="วันที่ประกาศ" />
                    <Collumn field="docPubDownload" header="จำนวน/ครั้ง" />
                </DataTable>
